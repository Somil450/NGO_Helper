...
import 'ngo_dashboard_view.dart';
import 'ngo_search_screen.dart';
import 'ngo_history_screen.dart';
import 'ngo_team_screen.dart';
...
class _NGOHomeScreenState extends State<NGOHomeScreen> {
  ...
  final List<_NavItem> _navItems = const [
    ...
    _NavItem(icon: LucideIcons.clipboardList, label: 'Claims'),
    _NavItem(icon: LucideIcons.users, label: 'Team'),
    _NavItem(icon: LucideIcons.settings, label: 'More'),
  ];
                  ...
                  Expanded(
                    child: IndexedStack(
                      ...
                      children: [
                        ...
                        const NGOSearchScreen(),
                        const NGOHistoryScreen(),
                        const NGOTeamScreen(),
                        const NGOSettingsScreen(),
                      ],
                    ),
                  ),
                ],
              ...
              children: [
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset('assets/images/logo.png', errorBuilder: (c, e, s) => const Icon(Icons.volunteer_activism, color: Color(0xFF00C98B), size: 28)),
                  ),
                ),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('NGO PORTAL', style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1.2)),
                    ),
                  ],
                ),
              ],
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildSidebarItem(LucideIcons.search, lang.translate('donations_dhundho'), 1),
                  _buildSidebarItem(LucideIcons.clipboardList, lang.translate('aapke_claims'), 2),
                  _buildSidebarItem(LucideIcons.users, lang.translate('team'), 3),
                  _buildSidebarItem(LucideIcons.settings, lang.translate('settings'), 4),
                  const Spacer(),
                  GestureDetector(
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Center(child: Text('A', style: GoogleFonts.bricolageGrotesque(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w900))),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Admin', style: GoogleFonts.inter(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w700)),
                      Text('NGO Manager', style: GoogleFonts.inter(color: Colors.white60, fontSize: 11)),
                    ],
                  ),
                ),
              ],
